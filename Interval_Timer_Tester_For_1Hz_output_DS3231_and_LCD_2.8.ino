...
// 17 April 2019 Working on DIP switch input for fiddle factor used to get the time difference closer to zero (Not used yet. Jan 2020)
...
void loop() {
  ...
  unsigned long diff = ((time3 - time2) / 1000); // Time difference in mS
